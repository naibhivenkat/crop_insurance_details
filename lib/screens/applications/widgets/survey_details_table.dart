...
//   const SurveyDetailsTable({super.key});

//   @override
//   State<SurveyDetailsTable> createState() => _SurveyDetailsTableState();
// }

// class _SurveyDetailsTableState extends State<SurveyDetailsTable> {
//   final List<SurveyRowController> rows = [];

//   final List<String> crops = const ["Arecanut", "Pepper", "Paddy"];
...
//     final totalGunte = (row.acre * 40) + row.gunte + (row.subGunte / 16) + 200;
...
//                           child: TextField(
//                             controller: row.surveyNoController,
...
//                           child: TextField(
//                             controller: row.gunteController,
...
//                           child: TextField(
//                             controller: row.subGunteController,
...
class _SurveyDetailsTableState extends State<SurveyDetailsTable> {
  ...
  void calculate(int index) {
    ...
    final landAmount = totalGunte * getRate(row.crop);

    row.amount = landAmount + surveyCharge;
