...
//     final farmer = await FirebaseFirestore.instance
//         .collection("farmers")
//         .doc(widget.farmerId)
//         .get();
...
//       final farmerRef = firestore.collection("farmers").doc(widget.farmerId);
...
//       final oldRows = await farmerRef.collection("surveyDetails").get();
...
//       for (int i = 0; i < surveyRows.length; i++) {
//         final row = surveyRows[i];

//         final detailRef = farmerRef.collection("surveyDetails").doc();
